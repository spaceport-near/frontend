  ...
  return (
    <div className="flex flex-col gap-y-[15px]">
      {myAssetsTableData.map((item, index) => (
        <div
          key={index}
          className="flex items-center justify-between primaryBorder pt-[21px] pr-[13px] pb-[19px] pl-[24px] "
        >
          ...
          <div className="flex gap-x-[25px]">
            {item.price === '1.00' ? (
              <button
                className="bg-primary py-[10px] px-[25px] rounded-[4px] hover:bg-primaryLight"
              ...
              <>
                <button
                  className="bg-primary py-[10px] px-[18px] rounded-[4px] hover:bg-primaryLight"
