...
const AccountSelection = ({setOpenModal, phrase, handleChangePhrase, handleDockAccount}) => {
      ...
      <div className="flex flex-col min-h-full">
        ...
        />
          ...
          <div className='self-center flex pt-[26px] flex-col'>
            <button className="flex items-center justify-center m-auto h-[42px] px-[20px] bg-primary rounded-[4px] hover:bg-primaryLight disabled:bg-primaryLight" disabled={!isChecked} onClick={handleDockAccount}>
              Dock Account
